...
import com.globits.salary.service.SalaryIncrementTypeService;
...
//            SalaryIncrementType.setModifiedBy(currentUserName);
    ...
    public Page<SalaryIncrementTypeDto> searchByPage(SearchDto dto) {
        ...
        String sql = "select new  com.globits.salary.dto.SalaryIncrementTypeDto(entity) from SalaryIncrementType as entity where (1=1) ";
