...
import ChooseStaffsPopupFilter from "./ChooseStaffsPopupFilter";

/*
*   Select multiple staffs
*/
function ChooseStaffsPopupToolbar(props) {
    const {
        isDisableFilter
    } = props;
...
export default memo(observer(ChooseStaffsPopupToolbar));
