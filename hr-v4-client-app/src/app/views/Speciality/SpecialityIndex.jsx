...
import CivilServantCategoryList from "./SpecialityList";
...
export default observer(function ColorIndex() {
    ...
    return (<div className="content-index">
            <div className="index-breadcrumb">
                <GlobitsBreadcrumb routeSegments={[{name: t("speciality.title")}]}/>
            </div>
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={12} md={6}>
                                    ...
                                    >
                                        ...
                                        <Button
                                            disabled={selectedSpecialityList.length <= 0}
