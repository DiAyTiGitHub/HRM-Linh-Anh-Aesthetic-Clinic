...
import TrainingBaseList from "./TrainingBaseList";
import GlobitsConfirmationDialog from "../../common/GlobitsConfirmationDialog";
import {useTheme} from "@material-ui/core/styles";
import useMediaQuery from "@material-ui/core/useMediaQuery";
import TrainingBaseForm from "./TrainingBaseForm";
import GlobitsSearchInput from "app/common/GlobitsSearchInput";
import {Form, Formik} from "formik";
import GlobitsTextField from "../../common/form/GlobitsTextField";
import SearchIcon from "@material-ui/icons/Search";

export default observer(function TrainingBaseIndex() {
    ...
    return (
        <div className="content-index">
            <div className="index-breadcrumb">
                <GlobitsBreadcrumb
                    routeSegments={[{name: t("trainingBase.title")}]}
                />
            </div>
                                ...
                                <Grid item xs={12} md={6}>
                                    ...
                                    >
                                        <Button
                                            startIcon={<AddIcon/>}
                                            type="button"
                                            onClick={() => handleEditTrainingBase()}
                                        >
                                            {!isMobile && t("general.button.add")}
                                        </Button>
                                        <Button
                                            disabled={selectedTrainingBaseList.length <= 0}
