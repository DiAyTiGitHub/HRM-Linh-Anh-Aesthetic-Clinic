...
import AllowanceFilter from "./StaffPositionFilter";
import StaffPositionFilter from "./StaffPositionFilter";

function StaffPositionToolbar() {
                                ...
                                <Grid item xs={12} md={6}>
                                    <div className="flex justify-between align-center">
                                        <Tooltip placement="top" title="Tìm kiếm theo tên, mã chính sách phụ cấp">
                                            <GlobitsTextField
                                                placeholder="Tìm kiếm theo tên nhân viên, tên người quản lý, tên phòng ban, vị trí ..."
                                                name="keyword"
                                                variant="outlined"
                                                notDelay
                                            />
...
export default memo(observer(StaffPositionToolbar));