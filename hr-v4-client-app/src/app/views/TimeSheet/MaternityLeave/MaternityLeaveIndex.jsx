...
import PeriodSettingList from "./MaternityLeaveList";
import BlockIcon from '@material-ui/icons/Block';
import HighlightOffIcon from '@material-ui/icons/HighlightOff';
import SearchIcon from '@material-ui/icons/Search';

const MaternityLeaveIndex = () => {
      ...
      <div className="index-breadcrumb">
        <GlobitsBreadcrumb
          routeSegments={[
            ...
            { name: t("navigation.timeSheet.leaveManagement") },
            { name: t("navigation.timeSheet.maternityLeave") },
          ]}
        />
      </div>
      <div>
...
export default MaternityLeaveIndex;
