...
export default observer(function AcademicIndex() {
    ...
    return (
        <div className="content-index">
            <div className="index-breadcrumb">
                <GlobitsBreadcrumb routeSegments={[{name: t("academic.title")}]}/>
            </div>
            <Grid className="index-card" container spacing={2}>
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={12} md={6}>
                                    ...
                                    >
                                        ...
                                        <Button
                                            disabled={selectedAcademicList.length <= 0}
                ...
                <AcademicForm open={shouldOpenEditorDialog}/>
