...
import StaffIpKeepingFilter from "./StaffIpKeepingFilter";

function StaffIpKeepingToolbar() {
                                ...
                                <Grid item xs={12} md={6}>
                                    ...
                                    >
                                        ...
                                        <Button
                                            ...
                                            disabled={selectedListStaffIpKeeping?.length <= 0}
                                        >
                                            Xóa
                                        </Button>
                                    </ButtonGroup>
...
export default memo(observer(StaffIpKeepingToolbar));