...
function OvertimeRequestRequestTableInfo (props) {
  ...
  useEffect (function () {
    ...
    // setFieldValue ("requestOTHoursBeforeShift", values?.requestOTHoursBeforeShift ?? convertedHours);
  ...
  useEffect (function () {
    ...
    // setFieldValue ("requestOTHoursAfterShift", values?.requestOTHoursAfterShift ?? convertedHours);
                ...
                <TableRow className={classes.tableBody}>
                  ...
                  <TableCell align="center" className="p-0">
                    <GlobitsVNDCurrencyInput
                        ...
                        readOnly={readOnly || !(formatNumber (values?.staffWorkSchedule?.earlyArrivalHours) >= 0.5)}
                    />
                  </TableCell>
                ...
                <TableRow className={classes.tableBody}>
                  ...
                  <TableCell align="center" className="p-0">
                    <GlobitsVNDCurrencyInput
                        ...
                        disabled={values?.approvalStatus == LocalConstants.OvertimeRequestApprovalStatus.APPROVED.value}
                        readOnly={readOnly || !(formatNumber (values?.staffWorkSchedule?.lateExitHours) >= 0.5)}
                    />
                  </TableCell>
...
export default memo (observer (OvertimeRequestRequestTableInfo));