...
export default observer(function InsurancePackageList() {
    ...
    let columns = [
            ...
            render: (rowData) => (
                <MaterialButton
                    ...
                    onSelect={(rowData, method) => {
                        if (method === 0) {
                            handleEditInsurancePackage(rowData.id);
                        } else if (method === 1) {
        ...
        {
            title: t("Mã gói bảo hiểm"),
            field: "name",
            width: "150",
        },
        {
            title: t("Tên gói bảo hiểm"),
            field: "code",
            width: "150",
        },
        {
            title: t("Mô tả gói bảo hiểm"),
            field: "description",
            width: "150",
        },
    ];
