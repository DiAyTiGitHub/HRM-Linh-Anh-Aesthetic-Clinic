...
import ShiftWorkTooltipDetails from "../StaffWorkScheduleCalendar/WorkSchedule/ShiftWorkTooltipDetails";
import Menu from "@material-ui/core/Menu";
import MenuItem from "@material-ui/core/MenuItem";
import CompareArrowsIcon from "@material-ui/icons/CompareArrows";
import localStorageService from "app/services/localStorageService";

function MonthCalendarTicket(props) {
    ...
    const {shiftWork , workingDate , readOnly , staffId} = props;
        ...
        <React.Fragment key={id}>
            <Tooltip
                title={
                    ...
                    />}
                placement='left'>
                <div className='monthCalendarTicket' style={kanbanCardStyle}>
...
export default memo(observer(MonthCalendarTicket));
