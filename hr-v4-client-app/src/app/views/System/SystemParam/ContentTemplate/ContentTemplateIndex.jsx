...
export default observer(function ContentTemplateIndex() {
    ...
    return (
        <div className="content-index">
            <div className="index-breadcrumb">
                <GlobitsBreadcrumb
                    routeSegments={[{ name: t("contentTemplate.title") }]}
                />
            </div>
            ...
            <Grid className="index-card" container spacing={2}>
                                    ...
                                    <Grid item xs={12} md={6}>
                                        ...
                                        >
                                            <Button
                                                startIcon={<AddIcon />}
                                                type="button"
                                                onClick={() => handleEditContentTemplate()}
                                            >
                                                {!isMobile && t("general.button.add")}
                                            </Button>
                                            <Button
                                                disabled={selectedcontentTemplateList?.length <= 0}
                ...
                <ContentTemplateForm  open={shouldOpenEditorDialog} />
