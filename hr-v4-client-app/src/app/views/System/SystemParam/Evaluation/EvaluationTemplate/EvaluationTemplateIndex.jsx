    ...
    return (
        <div className="content-index">
            <div className="index-breadcrumb">
                <GlobitsBreadcrumb
                    routeSegments={[{ name: t("evaluationTemplate.title") }]}
                />
            </div>
            ...
            <Grid className="index-card" container spacing={2}>
                                    ...
                                    <Grid item xs={12} md={6}>
                                        ...
                                        >
                                            <Button
                                                startIcon={<AddIcon />}
                                                type="button"
                                                onClick={() => handleEditEvaluationTemplate()}
                                            >
                                                {!isMobile && t("general.button.add")}
                                            </Button>
                                            <Button
                                                disabled={selectedEvaluationTemplateList.length <= 0}
                ...
                <EvaluationTemplateForm  open={shouldOpenEditorDialog} />
