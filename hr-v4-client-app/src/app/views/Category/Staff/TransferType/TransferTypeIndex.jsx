...
const TransferTypeIndex = () => {
    ...
    const {transferTypeStore} = useStore();
    ...
    return (
        <div className="content-index">
            <div className="index-breadcrumb">
                <GlobitsBreadcrumb
                    routeSegments={[
                        ...
                        {name: t("navigation.category.staff.transferType")},
                    ]}
                />
            </div>
            ...
            {shouldOpenEditorDialog && <TransferTypeForm/>}
...
export default observer(TransferTypeIndex);
