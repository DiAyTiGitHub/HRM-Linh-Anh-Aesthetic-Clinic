...
import { getAllPositions } from "./LeavingJobReasonService";
import { getAllDepartments } from "./LeavingJobReasonService";
  ...
  return (
    <GlobitsPopupV2
      ...
      title={
        ...
        " " +
        t("navigation.category.staff.leaveReasons") 
      }
...
export default memo(observer(LeavingJobReasonForm));
