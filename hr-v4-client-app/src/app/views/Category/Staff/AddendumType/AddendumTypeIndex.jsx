...
import AddendumTypeForm from "./AddendumTypeForm";
import AddendumTypeList from "./AddendumTypeList";
import GlobitsTextField from "../../../../common/form/GlobitsTextField";
import SearchIcon from "@material-ui/icons/Search";

const AddendumTypeIndex = () => {
    ...
    return (
        <div className="content-index">
            <div className="index-breadcrumb">
                <GlobitsBreadcrumb
                    routeSegments={[
                        ...
                        {name: t("navigation.category.staff.typeAddendum")},
                    ]}
                />
            </div>
            ...
            {shouldOpenEditorDialog && <AddendumTypeForm/>}
            {shouldOpenConfirmationDialog && (
...
export default observer(AddendumTypeIndex);
