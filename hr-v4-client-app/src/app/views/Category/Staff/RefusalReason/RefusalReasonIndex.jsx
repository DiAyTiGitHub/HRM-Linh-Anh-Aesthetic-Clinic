...
import DisciplinaryReasonForm from "./RefusalReasonForm";
import DisciplinaryReasonList from "./RefusalReasonList";
import {Form, Formik} from "formik";
import GlobitsTextField from "../../../../common/form/GlobitsTextField";
import SearchIcon from "@material-ui/icons/Search";

const DisciplinaryReasonIndex = () => {
    const {refusalReasonStore} = useStore();
    ...
    return (
        <div className="content-index">
            <div className="index-breadcrumb">
                <GlobitsBreadcrumb
                    routeSegments={[
                        ...
                        {name: t("navigation.category.staff.reasonRefusal")},
                    ]}
                />
            </div>
            <Grid className='index-card' container spacing={2}>
                ...
                <Grid item xs={12}>
                    <DisciplinaryReasonList/>
                </Grid>
            </Grid>

            {shouldOpenEditorDialog && <DisciplinaryReasonForm/>}
...
export default observer(DisciplinaryReasonIndex);
