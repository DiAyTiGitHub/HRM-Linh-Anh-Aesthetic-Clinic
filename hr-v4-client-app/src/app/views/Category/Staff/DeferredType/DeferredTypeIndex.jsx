...
import DeferredTypeForm from "./DeferredTypeForm";
import DeferredTypeList from "./DeferredTypeList";
import {Form, Formik} from "formik";
import GlobitsTextField from "../../../../common/form/GlobitsTextField";
import SearchIcon from "@material-ui/icons/Search";

const DeferredTypeIndex = () => {

    const {deferredTypeStore} = useStore();
    ...
    return (
        <div className="content-index">
            <div className="index-breadcrumb">
                <GlobitsBreadcrumb
                    routeSegments={[
                        ...
                        {name: t("navigation.category.staff.suspendedType")},
                    ]}
                />
            </div>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} md={6}>
                                        ...
                                        >
                                            ...
                                            {/*<Button startIcon={<DashboardIcon/>} aria-describedby={id} type="button"*/}
                                            {/*        onClick={handleClick}>*/}
                                            {/*    Khác*/}
                                            {/*</Button>*/}
                                            {/*<Popover*/}
            ...
            {shouldOpenEditorDialog && <DeferredTypeForm/>}
            {shouldOpenConfirmationDialog && (
...
export default observer(DeferredTypeIndex);
