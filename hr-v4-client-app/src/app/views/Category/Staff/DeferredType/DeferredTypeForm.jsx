  ...
  return (
    <GlobitsPopupV2
      ...
      title={
        ...
        " " +
        t("navigation.category.staff.suspendedType") 
      }
...
export default memo(observer(DeferredTypeForm));
