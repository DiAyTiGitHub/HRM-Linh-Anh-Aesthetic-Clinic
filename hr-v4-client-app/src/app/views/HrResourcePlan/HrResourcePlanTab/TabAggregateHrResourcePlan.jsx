...
import { pagingHrResourcePlan } from "../HrResourcePlanService";
import { formatDate } from "app/LocalFunction";

function TabAggregateHrResourcePlan() {
    ...
    let columns = [
        ...
        {
            title: t("Ngày tổng hợp định biên"),
            field: "planDate",
            align: "left",
    ...
    return (
        <GlobitsTable
            selection
            data={aggregateHrResourcePlanList}
...
export default memo(observer(TabAggregateHrResourcePlan));
