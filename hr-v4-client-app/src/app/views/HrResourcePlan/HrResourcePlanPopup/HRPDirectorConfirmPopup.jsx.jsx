...
function HRPDirectorConfirmPopup () {
  const {
    hrResourcePlanStore
  ...
  const {
    openDirectorConfirmPopup,
    handleClose,
    handleConfirmUpdateStatusByDirector,
    listOnDelete,
  ...
  return (
      <GlobitsColorfulThemePopup
          open={openDirectorConfirmPopup}
          handleClose={handleCloseConfirmPopup}
          size="lg"
          onConfirm={handleConfirmUpdateStatusByDirector}
      >
...
export default memo (observer (HRPDirectorConfirmPopup));