...
function HRPViceDirectorConfirmPopup() {
    const {
        hrResourcePlanStore
    ...
    const {
        openViceDirectorConfirmPopup,
        handleClose,
        handleConfirmUpdateStatusByViceDirector,
        listOnDelete,
    ...
    return (
        <GlobitsColorfulThemePopup
            open={openViceDirectorConfirmPopup}
            handleClose={handleCloseConfirmPopup}
            size="lg"
            onConfirm={handleConfirmUpdateStatusByViceDirector}
        >
...
export default memo(observer(HRPViceDirectorConfirmPopup));