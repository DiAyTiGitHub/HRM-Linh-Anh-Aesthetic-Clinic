...
import OnboaredCandidateFilter from "./OnboaredCandidateFilter";
import {ExitToApp} from "@material-ui/icons";

function OnboaredCandidateToolbar() {
    ...
    async function handleFilter(values) {
        ...
        await pagingOnboardedCandidates();
    }
                                ...
                                <Grid item xs={12} lg={4}>
                                    ...
                                    >
                                        ...
                                        <Button
                                            disabled={listChosen?.length <= 0}
                                            startIcon={<ExitToApp/>}
                                            onClick={() => handleOpenResignListPopup(true)}
                                        >
                                            Nghỉ việc
                                        </Button>
                                    </ButtonGroup>
...
export default memo(observer(OnboaredCandidateToolbar));