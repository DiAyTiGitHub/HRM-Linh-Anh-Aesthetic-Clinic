...
import PassedCandidateFilter from "./PassedCandidateFilter";
import GlobitsDateTimePicker from "app/common/form/GlobitsDateTimePicker";

function PassedCandidateToolbar() {
...
export default memo(observer(PassedCandidateToolbar));