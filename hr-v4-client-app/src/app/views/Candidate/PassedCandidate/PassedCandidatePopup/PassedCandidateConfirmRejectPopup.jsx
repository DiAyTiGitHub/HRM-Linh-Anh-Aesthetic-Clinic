...
function PassedCandidateConfirmRejectPopup() {
    ...
    return (
        <GlobitsColorfulThemePopup
            ...
            hideFooter
            size="lg"
            onConfirm={handleConfirmRejectCandidate}
        >
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={4} md={3}>
                        <Formik
                            ...
                            onSubmit={handleConfirmRejectCandidate}
                        >
...
export default memo(observer(PassedCandidateConfirmRejectPopup));