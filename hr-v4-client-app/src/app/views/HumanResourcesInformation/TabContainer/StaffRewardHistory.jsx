...
import {
  ...
  TableCell,
  TableHead,
  TableRow, ButtonGroup,
} from "@material-ui/core";
import { useFormikContext, FieldArray } from "formik";
import { useTranslation } from "react-i18next";
import AddIcon from "@material-ui/icons/Add";
import moment from "moment";
import StaffRewardHistoryPopupAdd from "./Popup/StaffRewardHistoryPopupAdd";
...
export default function StaffRewardHistory() {
  ...
  const handleSubmitItem = (values) => {
    ...
    setFieldValue("rewardHistory", newList);
    setOpenPopup(false);
    setEditable(true);
  };
                    ...
                    <TableBody>
                      {list?.map((item, index) => (
                        <TableRow key={index}>
                          ...
                          <TableCell colSpan={1}>
                            {item?.rewardDate
                              ? moment(item?.rewardDate).format("DD/MM/YYYY")
                              : null}
                          </TableCell>
                          <TableCell colSpan={1}>
