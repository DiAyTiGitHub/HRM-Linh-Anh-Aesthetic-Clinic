...
import StaffRewardHistoryForm from "./OtherIncomeForm";
import { useStore } from "app/stores";
import StaffRewardHistoryList from "./OtherIncomeList";
...
export default observer (function OtherIncomeTab () {
      ...
      return (
          <>
            ...
            <Grid container spacing={2} className={classes.root}>
              ...
              <Grid item xs={12}>
                {listOtherIncome?.length > 0? (
                    <OtherIncomeList/>
                ) : (
                    <p className="w-100 text-center">Chưa có thu nhập/ khấu trừ khác nào</p>
                )}
              </Grid>
            </Grid>
