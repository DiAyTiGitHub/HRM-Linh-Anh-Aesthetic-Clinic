...
export default observer(function ProfessionIndex() {
    ...
    return (
        <div className="content-index">
            <div className="index-breadcrumb">
                <GlobitsBreadcrumb routeSegments={[{name: t("profession.title")}]}/>
            </div>
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={12} md={6}>
                                    ...
                                    >
                                        ...
                                        <Button
                                            disabled={selectedProfessionList.length <= 0}
