...
import InsuranceTypeList from "./InsregionAdminunitList";


const InsregionAdminunitIndex
 = () => {
      ...
      <div className="index-breadcrumb">
        <GlobitsBreadcrumb
          routeSegments={[
            ...
            { name: t("navigation.insurance.insregionAdminunit") }
          ]}
        />
      </div>
...
export default InsregionAdminunitIndex
;
