...
import InsuranceTypeList from "./SalaryInsuranceRegionList";


const SalaryInsuranceRegionIndex
 = () => {
      ...
      <div className="index-breadcrumb">
        <GlobitsBreadcrumb
          routeSegments={[
            ...
            { name: t("navigation.insurance.salaryInsuranceRegion") }
          ]}
        />
      </div>
...
export default SalaryInsuranceRegionIndex
;
