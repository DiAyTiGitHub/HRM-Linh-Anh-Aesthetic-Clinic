...
import InsuranceTypeList from "./InsuranceRegionList";


const InsuranceRegionIndex = () => {
      ...
      <div className="index-breadcrumb">
        <GlobitsBreadcrumb
          routeSegments={[
            ...
            { name: t("navigation.insurance.insuranceRegion") }
          ]}
        />
      </div>
...
export default InsuranceRegionIndex;
