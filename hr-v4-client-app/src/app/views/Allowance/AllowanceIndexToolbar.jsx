...
import AllowanceFilter from "./AllowanceFilter";

function AllowanceIndexToolbar() {
                            ...
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12} md={6}>
                                    <div className="flex justify-between align-center">
                                        <Tooltip placement="top" title="Tìm kiếm theo tên, mã phụ cấp">
                                            <GlobitsTextField
                                                placeholder="Tìm kiếm theo tên, mã phụ cấp"
                                                name="keyword"
                                                variant="outlined"
                                                notDelay
                                            />
...
export default memo(observer(AllowanceIndexToolbar));