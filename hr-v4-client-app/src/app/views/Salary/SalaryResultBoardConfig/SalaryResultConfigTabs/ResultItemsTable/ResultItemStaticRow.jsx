...
function ResultItemStaticRow(props) {
            ...
            >
                ...
                <th style={{ minWidth: "320px" }}>

                    {
                        ...
                        && (
                            <GlobitsTextField
                                value={data?.usingFormula}
                                name={withNameSpace("usingFormula")}
                            />
                        )}
                </th>
            </tr>
...
export default memo(observer(ResultItemStaticRow));