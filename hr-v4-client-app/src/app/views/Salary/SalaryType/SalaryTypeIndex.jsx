...
import SalaryTypeCUForm from "./SalaryTypeCUForm";

function SalaryTypeIndex() {
  ...
  return (
    <div className="content-index">
      <div className="index-breadcrumb">
        <GlobitsBreadcrumb routeSegments={[{ name: t("navigation.salary") }, { name: t("navigation.salaryType.title") }]} />
      </div>
                    ...
                    <Grid container spacing={2} className="align-center mainBarFilter">
                      ...
                      <Grid item xs={12} md={9}>
                        <div className="flex justify-between align-center">
                          <GlobitsTextField
                            placeholder="Tìm kiếm theo tên nhóm dữ liệu lương..."
                            name="keyword"
                            variant="outlined"
                            notDelay
                            timeOut={0}
...
export default memo(observer(SalaryTypeIndex));
