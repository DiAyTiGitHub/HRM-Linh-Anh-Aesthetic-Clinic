...
import SalaryTemplateFilter from "./SalaryTemplateFilter";
                            ...
                            <Grid container spacing={2}>
                                    ...
                                    {(isCompensationBenifit) && (
                                        ...
                                        >
                                            <Button
                                                startIcon={<AddIcon/>}
                                                type="button"
                                                onClick={() => setShouldOpenCreateForm(true)}
                                            >
                                                Thêm mới
                                            </Button>
                                            {/* <Button
                                ...
                                <Grid item xs={12} md={6}>
                                    <div className="flex justify-between align-center">
                                        <GlobitsTextField
                                            placeholder="Tìm kiếm theo mã, tên mẫu bảng lương..."
                                            name="keyword"
                                            variant="outlined"
                                            notDelay
                                        />
