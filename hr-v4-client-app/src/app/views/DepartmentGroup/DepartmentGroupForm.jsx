...
function DepartmentGroupForm() {
  ...
  async function handleSaveForm(values) {
    await saveDepartmentGroup(values);
    await pagingDepartmentGroup();
  }

  const [initialValues, setInitialValues] = useState(selectedDepartmentGroup);

  useEffect(function () {
    setInitialValues(selectedDepartmentGroup);
  }, [selectedDepartmentGroup, selectedDepartmentGroup?.id])
  ...
  return (
    <GlobitsPopupV2
      ...
      noDialogContent
      title={(selectedDepartmentGroup?.id ? t("general.button.edit") : t("general.button.add")) + ' ' + t("navigation.category.staff.departmentGroup")}
...
export default memo(observer(DepartmentGroupForm));