...
import FamilyRelationshipList from "./FamilyRelationshipList";
...
export default observer(function FamilyRelationshipIndex() {
    ...
    return (
        <div className="content-index">
            <div className="index-breadcrumb">
                <GlobitsBreadcrumb
                    routeSegments={[
                        ...
                        {name: t("humanResourcesInformation.familyRelationships")}]}
                />
            </div>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} md={6}>
                                        ...
                                        >
                                            <Button
                                                startIcon={<AddIcon/>}
                                                onClick={() => handleEditFamilyRelationship()}
                                            >
                                                {!isMobile && t("general.button.add")}
                                            </Button>
                                            <Button
                                                disabled={selectedFamilyRelationshipList
                                                    ?.length === 0}
                                            ...
                                            >
                                                <div className="menu-list-button">
                                                    ...
                                                    >
                                                        <UpdateIcon style={{fontSize: 16}}/> Cập nhật trạng
                                                        thái
                                                    </div>
            ...
            {shouldOpenEditorDialog && <FamilyRelationshipForm open={shouldOpenEditorDialog}/>}
