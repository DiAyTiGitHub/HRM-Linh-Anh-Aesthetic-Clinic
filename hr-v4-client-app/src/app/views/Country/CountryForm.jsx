...
export default observer(function CountryForm(props) {
    const {countryStore} = useStore();
    const {t} = useTranslation();
    const {handleClose, createCountry, editCountry, selectedCountry, intactCountry} =
        countryStore;

    const [country, setCountry] = useState(intactCountry);
    ...
    return (
        <GlobitsPopupV2
            ...
            open={props.open}
            noDialogContent
            title={(selectedCountry?.id ? t("general.button.edit") : t("general.button.add")) + ' ' + t("country.title")}
