...
import { pagingStaffWorkSchedule } from "app/views/StaffWorkScheduleV2/StaffWorkScheduleService";
...
import ConfirmStaffWorkScheduleTableInfo from "../ConfirmStaffWorkScheduleTableInfo";

function ConfirmStaffWorkScheduleForm(props) {
                                    ...
                                    <Grid container spacing={2}>
                                        ...
                                        <Grid item xs={12}>
                                            {values?.staffWorkSchedule?.id && (
                                                <ConfirmStaffWorkScheduleTableInfo readOnly={readOnly}/>
                                            )}
...
export default memo(observer(ConfirmStaffWorkScheduleForm));