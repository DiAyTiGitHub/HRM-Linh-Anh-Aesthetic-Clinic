...
import CivilServantCategoryList from "./EducationTypeList";
import GlobitsConfirmationDialog from "../../common/GlobitsConfirmationDialog";
import {useTheme} from "@material-ui/core/styles";
import useMediaQuery from "@material-ui/core/useMediaQuery";
import EducationTypeForm from "./EducationTypeForm";
...
export default observer(function ColorIndex() {
    ...
    useEffect(() => {
        search();
        return resetEducationTypeStore;
    }, []);
    ...
    return (
        <div className="content-index">
            <div className="index-breadcrumb">
                <GlobitsBreadcrumb
                    routeSegments={[{name: t("educationType.title")}]}
                />
            </div>
            ...
            <Grid className="index-card" container spacing={2}>
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={12} md={6}>
                                    ...
                                    >
                                        ...
                                        <Button
                                            disabled={selectedEducationTypeList.length <= 0}
                ...
                <EducationTypeForm open={shouldOpenEditorDialog}/>
