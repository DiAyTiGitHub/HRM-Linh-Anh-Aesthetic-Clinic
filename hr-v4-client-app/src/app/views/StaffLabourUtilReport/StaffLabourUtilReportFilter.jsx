...
function StaffLabourUtilReportFilter(props) {
          ...
          <Grid item xs={12}>
            <div className='filterContent pt-8'>
              ...
              >
                ...
                <Grid item xs={12} sm={6} md={4} lg={3}>
                  <GlobitsDateTimePicker label='Tuyển dụng từ ngày' name='fromStartDate' />
                </Grid>

                <Grid item xs={12} sm={6} md={4} lg={3}>
                  <GlobitsDateTimePicker label='Tuyển dụng đến ngày' name='toStartDate' />
                </Grid>
                ...
                {/* <Grid item xs={12} sm={6} md={4} lg={3} className='pt-28 pl-20'>
                  <GlobitsCheckBox label='Có tham gia BHXH' name='hasSocialInsuranceNumber' />
                </Grid> */}
                ...
                <Grid item xs={12} className='pb-0'>
                  <p className='m-0 p-0 borderThrough2'>Thời gian đóng BHXH</p>
                </Grid>

                <Grid item xs={12} sm={6} md={4} lg={3}>
                  <GlobitsDateTimePicker
                    label='Kết thúc đóng BHXH từ ngày'
                    name='endSocialInsFromDate'
                  />
                </Grid>

                <Grid item xs={12} sm={6} md={4} lg={3}>
                  <GlobitsDateTimePicker
                    label='Kết thúc đóng BHXH đến ngày'
                    name='endSocialInsToDate'
                  />
                </Grid>
...
export default memo(observer(StaffLabourUtilReportFilter));
