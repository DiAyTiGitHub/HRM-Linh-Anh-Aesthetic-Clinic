...
import CivilServantCategoryList from "./EducationDegreeList";
...
export default observer(function EducationDegreeIndex() {
    ...
    useEffect(() => {
        search();
        return resetEducationDegreeStore;
    }, []);
    ...
    return (
        <div className="content-index">
            <div className="index-breadcrumb">
                <GlobitsBreadcrumb
                    routeSegments={[{name: t("educationDegree.title")}]}
                />
            </div>
            ...
            <Grid className="index-card" container spacing={2}>
                                ...
                                <Grid item xs={12} md={6}>
                                    ...
                                    >
                                        <Button
                                            startIcon={<AddIcon/>}
                                            type="button"
                                            onClick={() => handleEditEducationDegree()}
                                        >
                                            {!isMobile && t("general.button.add")}
                                        </Button>
                                        <Button
                                            disabled={selectedEducationDegreeList.length <= 0}
                ...
                <EducationDegreeForm open={shouldOpenEditorDialog}/>
